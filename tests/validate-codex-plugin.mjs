...
assert.equal(marketplace.interface.displayName, "Learning Goal");
...
assert.match(readme, /codex plugin marketplace add https:\/\/github\.com\/DrCatHicks\/learning-goal\.git/);
